...
# 1.	Write a query that returns the total revenue and total profit.
select sum(sales) as Revenue from company.data
ORDER BY sales desc limit 5;
select sum(profit) FROM company.data;

# 2.	Write a query that returns the DISTINCT values of the product sub-category
select * FROM company.product;
select distinct(sub_category) FROM company.product;

# 3.	Retrieve the SUM of revenue by product sub-category
...
# 4.	Retrieve the top 10 customers by revenue
SELECT distinct(customer_id), sum(sales) AS  revenue  FROM company.data 
group by customer_id 
order by revenue desc LIMIT 10;

#5.	Return the profit by country and order by the profit in Descending order.
SELECT * FROM company.location;
...
#6.	What month was the highest revenue made in 2015.
select * from company.data;
select * from company.calendar;
...
# 7.	Write a query that returns the total cost for each year.
SELECT * FROM company.data;
...
# 8.	Write a query that returns the total revenue and total profit for Canada and France
...
# 9.Write a query that returns the total profit of products that starts with letter “H”
...
# 10.	Write a query that returns the total revenue by month, ranked by revenue in ascending order.
...
# 11.	Retrieve top 10 states by average revenue?
...
# 12.	Retrieve countries by order quantity?
...
# 13.	What was the profit margin for the year 2016?
...
# 14.	What was the most profitable product in United State in 2016 purchased by Males
...
# 15.Who were the top 10 customers from British Columbia under the “Accessories Product Category”.
select * from company.data;
select * from company.location;
select * from company.product;
select * from company.customers;
